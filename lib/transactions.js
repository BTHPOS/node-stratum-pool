...
exports.createGeneration = function(rpcData, blockReward, feeReward, recipients, poolAddress){
    ...
    if (blockHeight.toString(16).length % 2 === 0) {
        var blockHeightSerial = rpcData.blockHeight.toString(16);
    } else {
        var blockHeightSerial = '0' + rpcData.blockHeight.toString(16);
    }
    ...
    if (rpcData.default_witness_commitment !== undefined) {
        tx.addOutput(bitcoin.script.compile(rpcData.default_witness_commitment), 0);
    }
