...
var ExtraNonceCounter = function () {
    var counter = crypto.randomBytes(8).readUIntLE(0, 8);
    console.log("New nonce counter from " + counter.toString());
    this.next = function () {
        var extraNonce = new Buffer(8);
        extraNonce.writeUIntBE(counter++, 0, 8);
        console.log("Next nonce counter " + counter.toString());
